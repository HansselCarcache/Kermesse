    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Kermesse registradas</h3>
              </div>
              <div class="card-body">
                <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_Kermesse.php" title="Registrar una nueva opcion"><i class="fas fa-plus-circle"></i> Registrar nueva kermesse</a>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $r->__GET('nombre_parroquia');?></td>
                        ...
                        <td><?php echo $r->__GET('usuarioC');?></td>
