...
include '../../entidades/ControlCaja/vw_tasacambioM.php';
          ...
          <div class="col-12">
            <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    foreach($dtTsc2->listTasaCambioM() as $r):
                  ?>

                    <tr>
                        <td><?php echo $r->__GET('id_tasaCambio');?></td>
                        <td><?php echo $r->__GET('nombreO');?></td>
                        <td><?php echo $r->__GET('nombreC');?></td>
                        <td><?php echo $r->__GET('mes');?></td>
                        <td><?php echo $r->__GET('anio');?></td>
                        <td><?php echo $r->__GET('cantidad');?></td>
                        <td>
                        <?php $var = $dtTsc2->getTasaCambiodet($r->__GET('id_tasaCambio'))?>
                          <a href="../../pages/ControlCaja/frm_edit_vw_tasacambio.php?editT=<?php echo $r->__GET('id_tasaCambio')?>&editTD=<?php echo $var->__GET('id_tasaCambio_det'); ?>">
