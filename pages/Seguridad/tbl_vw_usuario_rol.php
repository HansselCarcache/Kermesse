...
<head>
  ...
  <title>Seguridad | Roles Usuario</title>
    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Roles de Usuarios registrados</h3>
              </div>
              <div class="card-body">
              <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_usuario_rol.php" title="Registrar una nuevo usuario"><i class="fas fa-plus-circle"></i> Registrar nuevo rol a un usuario</a>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                        <th>ID Rol de Usuario</th>
                        <th>Usuario</th>
                  ...
                  <tbody>
                  <?php
                    foreach($dtUsr->listUsuarioRol() as $r):
                  ?>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          &nbsp;&nbsp;
                          <a href="frm_view_usuario_rol.php?editRU=<?php echo $r->__GET('id_rol_usuario'); ?>">
