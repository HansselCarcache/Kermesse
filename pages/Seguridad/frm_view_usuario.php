...
<head>
  ...
  <title>Seguridad | Visualizar Usuario</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="../../negocio/ng_usuario.php">
                ...
                <div class="form-group">
                    <label>Usuario</label>
                    <input type="text" class="form-control" id="usuario" name="usuario"  maxlength="40" placeholder="Ingrese el nombre del usuario" title="Ingrese el nombre del usuario" readonly required>
                  </div>
                 
                  <div class="form-group">
                    <label>Nombres</label>
                    <input type="text" class="form-control" id="nombres" name="nombres"  maxlength="45" placeholder="Ingrese sus nombres" title="Ingrese sus nombres" readonly required>
                    
                  </div>

                  <div class="form-group">
                    <label>Apellidos</label>
                    <input type="text" class="form-control" id="apellidos" name="apellidos"  maxlength="45" placeholder="Ingrese sus apellidos" title="Ingrese sus apellidos" readonly required>
                    
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="text" class="form-control" id="email" name="email"  maxlength="45" placeholder="Ingrese su correo electronico" title="Ingrese su correo electronico" readonly required>
                    
                  </div>

                  <?php
                      if($User->__GET('estado')==1 || $User->__GET('estado')==2){
                        $estado = "Activo";
                      }else{
                        $estado = "Inactivo";
                  ...
                  <div class="form-group">    
                    <label>Estado</label>
                    <input type="text" class="form-control" id="estado" name="estado"  maxlength="45" placeholder="Ingrese su correo electronico" title="Ingrese su correo electronico" readonly required>
                ...
                <a href="../../pages/Seguridad/tbl_usuario.php"><i class="fas fa fa-undo-alt"></i> Regresar</a> 
                  </div>
              </form>
              </div>
                <!-- /.card -->
