...
<head>
  ...
  <title>Seguridad | Editar Rol</title>
              ...
              <form method="POST" action="../../negocio/ng_rol.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rol_descripcion" name="rol_descripcion"  maxlength="70" placeholder="Ingrese el nombre de la opción" title="Ingrese el nombre de la opción"  required>
                  </div>
                </div>
                <!-- /.card-body -->
...
<script>
  function setValores()
  {
    ...
    $("#estado").val("<?php echo $Rol->__GET('estado') ?>")
  }
