            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="../../negocio/ng_usuario.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" pattern=".+@[a-z0-9.-]+\.com" class="form-control" id="email" name="email"  maxlength="45" placeholder="Ingrese su correo electronico" title="Ingrese su correo electronico"  required>
