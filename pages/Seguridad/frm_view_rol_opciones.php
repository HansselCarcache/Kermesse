  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visualizar Opciones de Rol</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Visualizar opcion de rol</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="../../negocio/ng_rol_opciones.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Opción</label>
                    <select class="form-control" id="id_opciones" name="id_opciones" disabled="true" required>
                    <option value="">Seleccione...</option>
                    <?php
                ...
                <a href="../../pages/Seguridad/tbl_vw_rol_opciones.php"><i class="fas fa fa-undo-alt"></i> Regresar</a>
                  </div>
              </form>
              </div>
                <!-- /.card -->
