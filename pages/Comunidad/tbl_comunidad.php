            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_comunidad.php" title="Registrar una nueva opcion"><i class="fas fa-plus-circle"></i> Registrar nueva comunidad</a>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th>Responsable</th>
                        <th>Descuento de contribucion</th>
                        <th>Estado</th>
                    </tr>
                  </thead>
                  <tbody>
