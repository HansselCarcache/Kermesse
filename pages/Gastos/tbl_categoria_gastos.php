    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Categoria de gastos registradas</h3>
              </div>
              <div class="card-body">
                <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_categoria_gastos.php" title="Registrar una nueva opcion"><i class="fas fa-plus-circle"></i> Registrar nueva categoria</a>
                </div>
