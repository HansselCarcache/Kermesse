          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_productos.php" title="Registrar una nueva opcion"><i class="fas fa-plus-circle"></i> Registrar un nuevo producto</a>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                        ...
                        <th>Nombre de categoria de productos</th>
                        <th>Nombre de producto</th>
                        <th>Descripcion</th>
                        <th>Cantidad</th>
                        <th>Precio de valor sugerido</th>
                        <th>Estado</th>
                  ...
                  <tbody>
                  <?php
                    foreach($dtpr->listProducto() as $r):
                  ?>

                    <tr>
                        <td><?php echo $r->__GET('id_producto');?></td>
                        <td><?php echo $r->__GET('nombre_comunidad');?></td>
                        <td><?php echo $r->__GET('nombre_categoriap');?></td>
