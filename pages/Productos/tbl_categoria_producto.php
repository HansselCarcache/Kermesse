   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Datos Categoria de Productos</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Categoria de productos registradas</h3>
              </div>
              <div class="card-body">
              <div class="form-group col-md-12" style="text-align: right;">
                  <a href="frm_categoria_producto.php" title="Registrar una nueva opcion"><i class="fas fa-plus-circle"></i> Registrar una nueva categoria de producto</a>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                        <th>ID Categoria de producto</th>
                        <th>Nombre</th>
                        <th>Descripcion</th>
                        <th>Estado</th>
